...
describe('StateSynchronizer', () => {
  ...
  describe('Event Emission', () => {
    it('should emit sync events', () => new Promise<void>((resolve) => {
    ...
    it('should maintain event history', () => {
      stateSynchronizer.emit({ type: 'update', timestamp: Date.now(), source: 'test1' });
      stateSynchronizer.emit({ type: 'delete', timestamp: Date.now(), source: 'test2' });
  ...
  describe('Event Types', () => {
    it('should handle different event types', () => new Promise<void>((resolve) => {
